...
const ReviewCard = ({
  ...
  return (
    <figure
      className={cn(
        "relative lg:h-[17rem] md:h-[15rem] sm:h-[20rem] h-[19rem] w-full cursor-pointer overflow-hidden rounded-xl border p-4",
        // light styles
...
export function MarqueeVertical() {
  return (
    <div className="relative flex h-[600px] w-full flex-row items-center justify-center overflow-hidden bg-background rounded-lg ">
